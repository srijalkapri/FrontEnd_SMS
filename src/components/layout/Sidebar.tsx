...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { to: '/admin/pending-users', label: 'Pending Users', icon: 'shield' },
      { to: '/admin/create-users', label: 'Create Users', icon: 'users' },
    ],
  },
  {
    label: 'Settings',
    ...
    <aside className={`sidebar ${mobileOpen ? 'sidebar--open' : ''}`}>
      ...
      >
        ...
        <div>
          ...
          <div className="sidebar__subtitle">SuperAdmin Portal</div>
        </div>
      </NavLink>
